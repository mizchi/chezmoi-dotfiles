---
title: "Getting Started — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/pilot/moonbit-pilot/getting-started.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/pilot/moonbit-pilot/getting-started.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Fpilot/moonbit-pilot/getting-started.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/pilot/moonbit-pilot/getting-started.md "Download source file")
* .pdf
...
# Getting Started[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#getting-started "Link to this heading")

## MoonBit Pilot[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#moonbit-pilot "Link to this heading")

![Image: MoonBit Pilot interface overview](https://docs.moonbitlang.com/en/stable/_images/pilot-01.png)
...
## Model Configuration[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#model-configuration "Link to this heading")
...
### Configuration Fields Explanation[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#configuration-fields-explanation "Link to this heading")

* **name**: A unique identifier for the model (used for reference)
* **description**: Human-readable description of the model
* **model\_name**: The actual model identifier used by the API provider
* **model\_type**: Type of API interface (currently supports "saas/openai")
* **base\_url**: API endpoint URL for the model provider
* **is\_reasoning**: Whether this is a reasoning model (affects token counting)
* **input\_price**: Cost per million input tokens (in USD)
* **output\_price**: Cost per million output tokens (in USD)
* **max\_output\_tokens**: Maximum number of tokens the model can output
* **context\_window**: Total context window size in tokens
* **api\_key**: Your API key for this provider

### About the Example Models[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#about-the-example-models "Link to this heading")
...
### Getting API Keys[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#getting-api-keys "Link to this heading")
...
## Setup[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#setup "Link to this heading")
...
## Usage[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#usage "Link to this heading")
...
## Interactive Mode[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#interactive-mode "Link to this heading")
...
### Interactive Commands[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#interactive-commands "Link to this heading")
...
### Exiting Interactive Mode[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#exiting-interactive-mode "Link to this heading")

* Use `:exit` or `Ctrl+D` to exit the application
* Use `Ctrl+C` to stop the current request and clear the current input

## Print/Non-Interactive Mode[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/getting-started.html#print-non-interactive-mode "Link to this heading")
