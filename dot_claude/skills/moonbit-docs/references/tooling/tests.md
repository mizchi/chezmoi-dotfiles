---
title: "Writing Tests — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/language/tests"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/language/tests.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/language/tests.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Flanguage/tests.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/language/tests.md "Download source file")
* .pdf
...
# Writing Tests[#](https://docs.moonbitlang.com/en/stable/language/tests.html#writing-tests "Link to this heading")
...
## Test Blocks[#](https://docs.moonbitlang.com/en/stable/language/tests.html#test-blocks "Link to this heading")
...
## Snapshot Tests[#](https://docs.moonbitlang.com/en/stable/language/tests.html#snapshot-tests "Link to this heading")
...
### Snapshotting `Show`[#](https://docs.moonbitlang.com/en/stable/language/tests.html#snapshotting-show "Link to this heading")
...
### Snapshotting `JSON`[#](https://docs.moonbitlang.com/en/stable/language/tests.html#snapshotting-json "Link to this heading")
...
### Snapshotting Anything[#](https://docs.moonbitlang.com/en/stable/language/tests.html#snapshotting-anything "Link to this heading")
...
## BlackBox Tests and WhiteBox Tests[#](https://docs.moonbitlang.com/en/stable/language/tests.html#blackbox-tests-and-whitebox-tests "Link to this heading")
