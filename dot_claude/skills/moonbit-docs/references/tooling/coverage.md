---
title: "Measuring code coverage — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/toolchain/moon/coverage.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/toolchain/moon/coverage.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Ftoolchain/moon/coverage.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/toolchain/moon/coverage.md "Download source file")
* .pdf
...
# Measuring code coverage[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#measuring-code-coverage "Link to this heading")
...
## Running code coverage in tests[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#running-code-coverage-in-tests "Link to this heading")
...
## Visualizing the coverage results[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#visualizing-the-coverage-results "Link to this heading")
...
### Text summary[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#text-summary "Link to this heading")
...
### OCaml Bisect format[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#ocaml-bisect-format "Link to this heading")
...
### Coveralls JSON format[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#coveralls-json-format "Link to this heading")
...
### Cobertura XML format[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#cobertura-xml-format "Link to this heading")
...
### HTML[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#html "Link to this heading")
...
![Index of the HTML](https://docs.moonbitlang.com/en/stable/_images/coverage_html_index.png)
...
![Detailed coverage data](https://docs.moonbitlang.com/en/stable/_images/coverage_html_page.png)

## Skipping coverage[#](https://docs.moonbitlang.com/en/stable/toolchain/moon/coverage.html#skipping-coverage "Link to this heading")
