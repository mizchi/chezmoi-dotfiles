---
title: "Model Configuration — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/pilot/moonbit-pilot/model-configuration.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/pilot/moonbit-pilot/model-configuration.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Fpilot/moonbit-pilot/model-configuration.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/pilot/moonbit-pilot/model-configuration.md "Download source file")
* .pdf
...
# Model Configuration[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#model-configuration "Link to this heading")

## Model Management[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#model-management "Link to this heading")
...
## Configuration Parameters[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#configuration-parameters "Link to this heading")
...
## Example Models[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#example-models "Link to this heading")

The configuration above includes two popular models:

### Claude Sonnet 4 (`sonnet4`)[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#claude-sonnet-4-sonnet4 "Link to this heading")
...
### Kimi K2 (`k2`)[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#kimi-k2-k2 "Link to this heading")
...
## Supported Models[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#supported-models "Link to this heading")
...
### Configuration Examples[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#configuration-examples "Link to this heading")

Here are configuration examples for some of the supported models:

#### DeepSeek V3[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#deepseek-v3 "Link to this heading")
...
#### Claude Sonnet 3.7[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#claude-sonnet-3-7 "Link to this heading")
...
#### Gemini 2.5 Pro[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#gemini-2-5-pro "Link to this heading")
...
## Getting API Keys[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#getting-api-keys "Link to this heading")

To use these models, you'll need to obtain API keys from the respective providers:

### OpenRouter (for Claude Sonnet 4)[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#openrouter-for-claude-sonnet-4 "Link to this heading")
...
### Moonshot (for Kimi K2)[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#moonshot-for-kimi-k2 "Link to this heading")
...
### DeepSeek (for DeepSeek V3/R1)[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#deepseek-for-deepseek-v3-r1 "Link to this heading")
...
## Usage[#](https://docs.moonbitlang.com/en/stable/pilot/moonbit-pilot/model-configuration.html#usage "Link to this heading")
