---
title: "G-Machine 1 — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/example/gmachine/gmachine-1.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/example/gmachine/gmachine-1.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Fexample/gmachine/gmachine-1.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/example/gmachine/gmachine-1.md "Download source file")
* .pdf
...
# G-Machine 1[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#g-machine-1 "Link to this heading")
...
## Higher-Order Functions and Performance Challenges[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#higher-order-functions-and-performance-challenges "Link to this heading")
...
## Lazy List Implementation[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#lazy-list-implementation "Link to this heading")
...
## A Lazy Evaluation Language and Its Abstract Syntax Tree[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#a-lazy-evaluation-language-and-its-abstract-syntax-tree "Link to this heading")
...
## Why Graph[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#why-graph "Link to this heading")
...
## Conventions[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#conventions "Link to this heading")
...
### Step 1: Find the next redex[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#step-1-find-the-next-redex "Link to this heading")
...
### Step 2: Reduce[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#step-2-reduce "Link to this heading")
...
### Step 3: Update[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#step-3-update "Link to this heading")
...
## G-Machine Overview[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#g-machine-overview "Link to this heading")
...
## Dissecting the G-Machine State[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#dissecting-the-g-machine-state "Link to this heading")
...
## Corresponding Effect of Each Instruction[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#corresponding-effect-of-each-instruction "Link to this heading")
...
## Compiling Super Combinators into Instruction Sequences[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#compiling-super-combinators-into-instruction-sequences "Link to this heading")
...
## Running the G-Machine[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#running-the-g-machine "Link to this heading")
...
## Conclusion[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#conclusion "Link to this heading")
...
## Reference[#](https://docs.moonbitlang.com/en/stable/example/gmachine/gmachine-1.html#reference "Link to this heading")
