---
title: "Myers diff 3 — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff3"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/example/myers-diff/myers-diff3.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/example/myers-diff/myers-diff3.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Fexample/myers-diff/myers-diff3.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/example/myers-diff/myers-diff3.md "Download source file")
* .pdf
...
# Myers diff 3[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff3.html#myers-diff-3 "Link to this heading")

This article is the third in the [diff series](https://docs.moonbitlang.com/en/stable/example/myers-diff/index.html). In the [previous part](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff2.html), we explored the full Myers algorithm and its limitations. In this post, we'll learn how to implement a variant of the Myers algorithm that operates with linear space complexity.

## Divide and Conquer[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff3.html#divide-and-conquer "Link to this heading")
...
### Code Implementation[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff3.html#code-implementation "Link to this heading")
...
## Conclusion[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff3.html#conclusion "Link to this heading")
