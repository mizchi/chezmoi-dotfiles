---
title: "Myers diff — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/example/myers-diff/myers-diff.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/example/myers-diff/myers-diff.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Fexample/myers-diff/myers-diff.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/example/myers-diff/myers-diff.md "Download source file")
* .pdf
...
# Myers diff[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff.html#myers-diff "Link to this heading")
...
## Defining "Difference" and Its Measurement Criteria[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff.html#defining-difference-and-its-measurement-criteria "Link to this heading")
...
+
+ fn RHSet::new[T](https://docs.moonbitlang.com/en/stable/example/myers-diff/capacity : Int) -> RHSet[T] {
...
## Algorithm Overview[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff.html#algorithm-overview "Link to this heading")
...
## Implementation[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff.html#implementation "Link to this heading")
...
```
///
struct BPArray[T](https://docs.moonbitlang.com/en/stable/example/myers-diff/Array[T]) // BiPolar Array
...
## Epilogue[#](https://docs.moonbitlang.com/en/stable/example/myers-diff/myers-diff.html#epilogue "Link to this heading")
