---
title: "Method and Trait — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/language/methods"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/language/methods.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/language/methods.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Flanguage/methods.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/language/methods.md "Download source file")
* .pdf
...
# Method and Trait[#](https://docs.moonbitlang.com/en/stable/language/methods.html#method-and-trait "Link to this heading")

## Method system[#](https://docs.moonbitlang.com/en/stable/language/methods.html#method-system "Link to this heading")
...
using package with alias list[#](https://docs.moonbitlang.com/en/stable/language/methods.html#id1 "Link to this code")
...
### Local method[#](https://docs.moonbitlang.com/en/stable/language/methods.html#local-method "Link to this heading")

To ensure single source of truth in method resolution and avoid ambiguity,
[methods can only be defined in the same package as its type](https://docs.moonbitlang.com/en/stable/language/packages.html#trait-implementations).
...
### Alias methods as functions[#](https://docs.moonbitlang.com/en/stable/language/methods.html#alias-methods-as-functions "Link to this heading")
...
## Operator Overloading[#](https://docs.moonbitlang.com/en/stable/language/methods.html#operator-overloading "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/methods.html#id2 "Link to this code")
...
## Trait system[#](https://docs.moonbitlang.com/en/stable/language/methods.html#trait-system "Link to this heading")
...
### Extending traits[#](https://docs.moonbitlang.com/en/stable/language/methods.html#extending-traits "Link to this heading")
...
### Implementing traits[#](https://docs.moonbitlang.com/en/stable/language/methods.html#implementing-traits "Link to this heading")
...
in order to support features such as [abstract trait](https://docs.moonbitlang.com/en/stable/language/packages.html#traits).
...
### Using traits[#](https://docs.moonbitlang.com/en/stable/language/methods.html#using-traits "Link to this heading")
...
#### Invoke trait methods directly[#](https://docs.moonbitlang.com/en/stable/language/methods.html#invoke-trait-methods-directly "Link to this heading")
...
### Trait alias[#](https://docs.moonbitlang.com/en/stable/language/methods.html#trait-alias "Link to this heading")
...
## Trait objects[#](https://docs.moonbitlang.com/en/stable/language/methods.html#trait-objects "Link to this heading")
...
## Builtin traits[#](https://docs.moonbitlang.com/en/stable/language/methods.html#builtin-traits "Link to this heading")
...
### Deriving builtin traits[#](https://docs.moonbitlang.com/en/stable/language/methods.html#deriving-builtin-traits "Link to this heading")
...
See [Deriving](https://docs.moonbitlang.com/en/stable/language/derive.html) for more information about deriving traits.
