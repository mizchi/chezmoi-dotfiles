---
title: "Fundamentals — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/language/fundamentals"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/language/fundamentals.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/language/fundamentals.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Flanguage/fundamentals.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/language/fundamentals.md "Download source file")
* .pdf
...
# Fundamentals[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#fundamentals "Link to this heading")

## Built-in Data Structures[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#built-in-data-structures "Link to this heading")

### Unit[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#unit "Link to this heading")
...
### Boolean[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#boolean "Link to this heading")
...
### Number[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#number "Link to this heading")
...
[Overloaded Literals](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#overloaded-literals)

### String[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#string "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id1 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id2 "Link to this code")
...
The [VSCode extension](https://docs.moonbitlang.com/en/stable/toolchain/vscode/index.html#actions) can help you switch between a plain text and the MoonBit's multiline string.
...
### Char[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#char "Link to this heading")
...
### Byte(s)[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#byte-s "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id3 "Link to this code")
...
### Tuple[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#tuple "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id4 "Link to this code")
...
### Ref[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#ref "Link to this heading")

A `Ref[T]` is a mutable reference containing a value `val` of type `T`.

It can be constructed using `{ val : x }`, and can be accessed using `ref.val`. See [struct](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#struct) for detailed explanation.
...
### Option and Result[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#option-and-result "Link to this heading")
...
See [enum](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#enum) for detailed explanation.
...
### Array[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#array "Link to this heading")
...
#### ArrayView[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#arrayview "Link to this heading")
...
### Map[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#map "Link to this heading")
...
Currently keys in map literal syntax must be constant. `Map`s can also be destructed elegantly with pattern matching, see [Map Pattern](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#map-pattern).
...
### Json[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#json "Link to this heading")
...
Json values can be pattern matched too, see [Json Pattern](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#json-pattern).
...
## Overloaded Literals[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#overloaded-literals "Link to this heading")
...
There are also some similar overloading rules in pattern. For more details, see [Pattern Matching](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#pattern-matching).
...
### Escape Sequences in Overloaded Literals[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#escape-sequences-in-overloaded-literals "Link to this heading")
...
## Functions[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#functions "Link to this heading")
...
### Top-Level Functions[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#top-level-functions "Link to this heading")
...
### Local Functions[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#local-functions "Link to this heading")
...
### Function Applications[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#function-applications "Link to this heading")
...
### Partial Applications[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#partial-applications "Link to this heading")
...
### Labelled arguments[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#labelled-arguments "Link to this heading")
...
### Optional arguments[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#optional-arguments "Link to this heading")
...
#### Optional arguments without default values[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#optional-arguments-without-default-values "Link to this heading")
...
### Autofill arguments[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#autofill-arguments "Link to this heading")
...
### Function alias[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#function-alias "Link to this heading")
...
Function alias can be used to import functions from other [packages](https://docs.moonbitlang.com/en/stable/language/packages.html).
...
## Control Structures[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#control-structures "Link to this heading")

### Conditional Expressions[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#conditional-expressions "Link to this heading")
...
### Match Expression[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#match-expression "Link to this heading")

The `match` expression is similar to conditional expression, but it uses [pattern matching](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#pattern-matching) to decide which consequent to evaluate and extracting variables at the same time.
...
### Guard Statement[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#guard-statement "Link to this heading")
...
#### Guard statement and is expression[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#guard-statement-and-is-expression "Link to this heading")

The `let` statement can be used with [pattern matching](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#pattern-matching). However, `let` statement can only handle one case. And using [is expression](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#is-expression) with `guard` statement can solve this issue.
...
### While loop[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#while-loop "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id5 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id6 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id7 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id8 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id9 "Link to this code")

```
7
```

### For Loop[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#for-loop "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id10 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id11 "Link to this code")
...
### `for .. in` loop[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#for-in-loop "Link to this heading")
...
For more information of the `Iter` type, see [Iterator](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#iterator) below.
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id12 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id13 "Link to this code")
...
### Functional loop[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#functional-loop "Link to this heading")
...
### Labelled Continue/Break[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#labelled-continue-break "Link to this heading")
...
### `defer` expression[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#defer-expression "Link to this heading")
...
It can handle [error](https://docs.moonbitlang.com/en/stable/language/error-handling.html),
...
## Iterator[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#iterator "Link to this heading")
...
### Implementation details[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#implementation-details "Link to this heading")
...
## Custom Data Types[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#custom-data-types "Link to this heading")

There are two ways to create new data types: `struct` and `enum`.

### Struct[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#struct "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id14 "Link to this code")
...
#### Constructing Struct with Shorthand[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#constructing-struct-with-shorthand "Link to this heading")
...
#### Struct Update Syntax[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#struct-update-syntax "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id15 "Link to this code")
...
### Enum[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#enum "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id16 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id17 "Link to this code")
...
#### Constructor with labelled arguments[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#constructor-with-labelled-arguments "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id18 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id19 "Link to this code")
...
#### Constructor with mutable fields[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#constructor-with-mutable-fields "Link to this heading")
...
### Tuple Struct[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#tuple-struct "Link to this heading")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id20 "Link to this code")
...
Output[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#id21 "Link to this code")
...
### Type alias[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#type-alias "Link to this heading")
...
### Local types[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#local-types "Link to this heading")
...
## Pattern Matching[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#pattern-matching "Link to this heading")

Pattern matching allows us to match on specific pattern and bind data from data structures.

### Simple Patterns[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#simple-patterns "Link to this heading")
...
We can use `_` as wildcards for the values we don't care about, and use `..` to ignore remaining fields of struct or enum, or array (see [array pattern](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#array-pattern)).
...
### Array Pattern[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#array-pattern "Link to this heading")
...
### Range Pattern[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#range-pattern "Link to this heading")
...
### Map Pattern[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#map-pattern "Link to this heading")
...
* To match a data type `T` using map pattern, `T` must have a method `op_get(Self, K) -> Option[V]` for some type `K` and `V` (see [method and trait](https://docs.moonbitlang.com/en/stable/language/methods.html)).
...
### Json Pattern[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#json-pattern "Link to this heading")
...
### Guard condition[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#guard-condition "Link to this heading")
...
## Generics[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#generics "Link to this heading")
...
## Special Syntax[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#special-syntax "Link to this heading")

### Pipelines[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#pipelines "Link to this heading")
...
### Cascade Operator[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#cascade-operator "Link to this heading")
...
### is Expression[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#is-expression "Link to this heading")
...
### Spread Operator[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#spread-operator "Link to this heading")
...
### TODO syntax[#](https://docs.moonbitlang.com/en/stable/language/fundamentals.html#todo-syntax "Link to this heading")
