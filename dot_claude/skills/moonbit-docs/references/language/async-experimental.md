---
title: "Async programming support — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/language/async-experimental"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/language/async-experimental.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/language/async-experimental.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Flanguage/async-experimental.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/language/async-experimental.md "Download source file")
* .pdf
...
# Async programming support[#](https://docs.moonbitlang.com/en/stable/language/async-experimental.html#async-programming-support "Link to this heading")
...
## Async function[#](https://docs.moonbitlang.com/en/stable/language/async-experimental.html#async-function "Link to this heading")

Async functions are declared with the `async` keyword.
They implicitly [`raise`](https://docs.moonbitlang.com/en/stable/language/error-handling.html#throwing-errors) errors
...
## Async primitives for suspension[#](https://docs.moonbitlang.com/en/stable/language/async-experimental.html#async-primitives-for-suspension "Link to this heading")
...
## Integrating with JS Promise/callback based API[#](https://docs.moonbitlang.com/en/stable/language/async-experimental.html#integrating-with-js-promise-callback-based-api "Link to this heading")
