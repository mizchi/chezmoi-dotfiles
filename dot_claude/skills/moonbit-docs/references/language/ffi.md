---
title: "Foreign Function Interface (FFI) — MoonBit v0.6.27 documentation"
source_url: "https://docs.moonbitlang.com/en/stable/language/ffi"
fetched_at: "2025-12-19T08:15:11.537167+00:00"
---



* [Show source](https://github.com/moonbitlang/moonbit-docs/blob/main/next/language/ffi.md?plain=1 "Show source")
* [Suggest edit](https://github.com/moonbitlang/moonbit-docs/edit/main/next/language/ffi.md "Suggest edit")
* [Open issue](https://github.com/moonbitlang/moonbit-docs/issues/new?title=Issue%20on%20page%20%2Flanguage/ffi.html&body=Your%20issue%20content%20here. "Open an issue")

* [.md](https://docs.moonbitlang.com/en/stable/_sources/language/ffi.md "Download source file")
* .pdf
...
# Foreign Function Interface (FFI)[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#foreign-function-interface-ffi "Link to this heading")
...
## Backends[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#backends "Link to this heading")
...
JavaScript backend will generate a JavaScript file, which can be a CommonJS module, an ES module or an IIFE based on the [configuration](https://docs.moonbitlang.com/en/stable/toolchain/moon/package.html#js-backend-link-options).

C

C backend will generate a C file. The MoonBit toolchain will also compile the project and generate an executable based on the [configuration](https://docs.moonbitlang.com/en/stable/toolchain/moon/package.html#native-backend-link-options).

LLVM

LLVM backend will generate an object file. The backend is experimental and does not support FFIs.

## Declare Foreign Type[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#declare-foreign-type "Link to this heading")
...
## Declare Foreign Function[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#declare-foreign-function "Link to this heading")
...
### Types[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#types "Link to this heading")
...
### Callbacks[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#callbacks "Link to this heading")
...
### Customize integer value of constant enum[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#customize-integer-value-of-constant-enum "Link to this heading")
...
## Export Functions[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#export-functions "Link to this heading")

For public functions that are neither methods nor polymorphic, they can be exported by configuring the `exports` field in [link configuration](https://docs.moonbitlang.com/en/stable/toolchain/moon/package.html#link-options).
...
## Lifetime management[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#lifetime-management "Link to this heading")
...
### Lifetime management of external object[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#lifetime-management-of-external-object "Link to this heading")
...
### Lifetime management of MoonBit object[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#lifetime-management-of-moonbit-object "Link to this heading")
...
#### The calling convention of reference counting[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#the-calling-convention-of-reference-counting "Link to this heading")
...
#### The managed types[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#the-managed-types "Link to this heading")
...
#### The borrow and owned attribute[#](https://docs.moonbitlang.com/en/stable/language/ffi.html#the-borrow-and-owned-attribute "Link to this heading")
